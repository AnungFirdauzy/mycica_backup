            ...
            <div class="container-fluid">
                <div class="row row-cols-5 mt-3">
                    @foreach ($burung as $item)
                        <a href="/adm/katalog/detail/{{ $email }}/{{ $item->id }}" style="text-decoration: none; color: black"><div class="card me-auto mb-3 shadow" style="width: 330px;">
                            ...
                            <div class="card-body">
                                ...
                                <div class="container">
                                    ...
                                    <div class="row">
                                        <div class="col"><p>Status Burung </p></div>
