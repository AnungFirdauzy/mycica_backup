                ...
                @foreach ($katalog as $ktlg)
                        <div class="col text-start p-0">
                            <a href="/detail/investasi/{{ $ktlg->id_burungs }}" style="text-decoration: none; color: black"><div class="card mb-3 shadow" style="width: 330px;">
                                <img src="{{ asset("storage/".$ktlg->foto_burung) }}" class="card-img-top img-thumbnail mx-auto mt-1" alt="Foto Burung" style="width: 310px">
                                <div class="card-body">
                                    ...
                                    @elseif($ktlg->riwayat_transaksi == 'Menunggu verifikasi')
                                        <span class="badge bg-warning">Pembayaran Diverifikasi</span>
                                    @else
